...
EDGE_ADDR=":8081" EDGE_ENABLE_SMOKE_ROUTES="true" EDGE_ALLOW_INSECURE_NO_AUTH="true" EDGE_DB_DSN="postgres://exchange:exchange@localhost:25432/exchange?sslmode=disable" go run ./services/edge-gateway/cmd/edge-gateway >"$EDGE_LOG" 2>&1 &
EDGE_PID=$!
