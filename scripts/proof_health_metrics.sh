...
sources = {
    ...
    "runbook_network_partition": "build/runbooks/network-partition-latest.json",
    "runbook_redpanda_broker_bounce": "build/runbooks/redpanda-broker-bounce-latest.json",
    "runbook_adversarial_reliability": "build/runbooks/adversarial-reliability-latest.json",
