...
release-gate-fallback-smoke:
	./scripts/release_gate_fallback_smoke.sh
...
proof-health-metrics:
	./scripts/proof_health_metrics.sh

mapping-coverage-metrics:
	./scripts/mapping_coverage_metrics.sh
...
prove-mapping-coverage:
	./scripts/prove_mapping_coverage.sh

prove-policy-tamper:
	./scripts/prove_policy_tamper.sh

prove-release-gate-context:
	./scripts/prove_release_gate_context.sh
